    ...
    stages{
        ...
        stage('Deploy to K8s'){
            steps{
                ...
                sshagent(['k8s']) {
                    sh "scp -o StrictHostKeyChecking=no awgapp-depl.yaml testim@volomaster1:/home/testim/k8s/application/"
                    sh "ssh testim@volomaster1 kubectl apply -f ./k8s/application/"
                }
            }
        }
    }
